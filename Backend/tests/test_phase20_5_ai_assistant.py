...
class Phase205AiAssistantTests(unittest.TestCase):
    ...
    def test_02_assistant_health_endpoint_requires_auth(self):
        """Verify GET /clinical-assistant/health requires JWT authentication."""
        res = client.get("/clinical-assistant/health")
