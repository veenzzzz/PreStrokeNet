...
class Phase202DashboardTests(unittest.TestCase):
    ...
    def test_02_unauthenticated_dashboard_summary_returns_401(self):
        """Verify GET /dashboard/summary requires JWT authentication."""
