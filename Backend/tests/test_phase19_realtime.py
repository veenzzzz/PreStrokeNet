...
class Phase19RealtimeTests(unittest.TestCase):
    ...
    def test_02_unauthenticated_global_search_returns_401(self):
        """Verify GET /search/global requires JWT authentication."""
        res = client.get("/search/global?q=demo")
