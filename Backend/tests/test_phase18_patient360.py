...
class Phase18Patient360Tests(unittest.TestCase):
    def test_01_production_models_hash_integrity(self):
        """Verify stroke_model.pkl and keystroke_model.pkl SHA256 hashes are 100% intact."""
    ...
    def test_02_unauthenticated_patient360_endpoint_returns_401(self):
        """Verify GET /patients/{patient_id}/360 requires JWT authentication."""
        res = client.get("/patients/DEMO-360-1/360")
