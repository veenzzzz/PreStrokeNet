...
class Phase204ExplainabilityTests(unittest.TestCase):
    ...
    def test_02_unauthenticated_prediction_detail_returns_401(self):
        """Verify GET /predictions/{id} requires JWT authentication."""
        res = client.get("/predictions/1")
